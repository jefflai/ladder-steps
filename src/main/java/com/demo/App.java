...
/**
 * One ladder has 100 steps high, one rabbit can jump 1-4 steps each time, get
 * the total possibilities the rabbit can jump. For example: 1,1,1,1,…1 (100
 * times of 1), 2,2,2,2 … (50 times of 2), etc.
 */
public class App {
